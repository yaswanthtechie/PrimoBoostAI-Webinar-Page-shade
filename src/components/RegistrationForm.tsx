    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <input
            ...
            className={`w-full px-4 py-3 rounded-lg border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent bg-black/20 backdrop-blur-sm text-white placeholder-white/60 ${
      ...
      <div className="flex items-start gap-3">
        <input
          ...
          className="mt-1 w-4 h-4 text-blue-400 border-white/30 rounded focus:ring-blue-400 bg-black/20"
          disabled={isSubmitting}
        />
      ...
      <button
        type="submit"
        disabled={isSubmitting}
        className="w-full bg-white text-black font-medium py-4 px-8 rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-3 hover:bg-white/90"
      >
        {isSubmitting ? (
          <>
